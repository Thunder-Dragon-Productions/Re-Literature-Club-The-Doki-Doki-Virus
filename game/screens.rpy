...
# I don't know how to revert back to the original namebox after using namebox_belief so I repeated the above as substitution.
style namebox0:
    xpos gui.name_xpos
    xanchor gui.name_xalign
    xsize gui.namebox_width
...
## The text window box for the belief Club visions.
style window_belief is window:
    background Image("mod_assets/gui/textbox_belief.png", xalign=0.5, yalign=1.0)

style namebox_belief:
    xpos gui.name_xpos
    xanchor gui.name_xalign
    xsize gui.namebox_width
    ypos gui.name_ypos
    ...
    background Frame("mod_assets/gui/namebox_belief.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
    padding gui.namebox_borders.padding

style say_label_belief:
    color gui.accent_color
    font "mod_assets/fonts/CloisterBlack.ttf"
    size gui.name_text_size
    xalign gui.name_xalign
    yalign 0.5
    outlines [(3, "#3d69ba", 0, 0), (1, "#3d69ba", 1, 1)]
...
screen main_menu():
    ...
    if persistent.mc1_menu:
        add "menu_bg"
        add "menu_art_y"
        add "menu_art_n"
        add "menu_art_mc1"
        if persistent.mc2erika_menu:
            add "menu_art_mc2"
            add "menu_art_erika"
    else:
        add "menu_bg"
...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Made with {a=https://www.renpy.org/}{color=#9999FF}Ren'Py{/color}{/a} [renpy.version_only].\n\n[renpy.license!t]")
...
screen keyboard_help():
    ...
    hbox:
        label "V"
        text _("Toggles assistive {a=https://www.renpy.org/l/voicing}{color=#9999FF}self-voicing{/color}{/a}.")
